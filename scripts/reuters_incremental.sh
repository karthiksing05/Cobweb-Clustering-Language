...
#SBATCH --output=Cobweb-Clustering-Language/slurm/slurm_outputs/reuters_incremental.out
#SBATCH --error=Cobweb-Clustering-Language/slurm/slurm_errors/reuters_incremental.err
